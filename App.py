...
class App:
    def __init__(self, root):
        ...
        self.select_label = tk.Label(wrapper2)
        self.select_label["font"] = ft
        self.select_label["justify"] = "center"
        self.select_label["text"] = "Select"
        self.select_label.place(x=175, y=60, width=100, height=30)

        self.select_choices = ()
        self.select_clicked = tk.StringVar(wrapper2)
        self.select_checkbox = tk.OptionMenu(wrapper2, self.select_clicked, self.select_choices)
        self.select_checkbox["font"] = ft
        self.select_checkbox.place(x=255, y=60, width=130, height=30)
